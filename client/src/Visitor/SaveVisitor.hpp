...
public:
    ...
    */
    virtual void save(const Circle* circle) const = 0;
    /**
    * Saves the Segment.
    * @param segment The Segment to save.
    */
    virtual void save(const Segment* segment) const = 0;
    /**
    * Saves the Triangle.
    * @param triangle The Triangle to save.
    */
    virtual void save(const Triangle* triangle) const = 0;
    /**
    * Saves the Polygon.
    * @param polygon The Polygon to save.
    */
    virtual void save(const Polygon* polygon) const = 0;
};
