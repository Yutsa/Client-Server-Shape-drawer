...
Ensuite une autre "boucle infinie" attend inlassablement les différentes requêtes de l'utilisateur, jusqu'à ce qu'il n'y en ai plus, ou que l'utilisateur ai envoyé le message "quit" au thread.
